	...
	*/
    ...
    Uploader.prototype = {
        ...
        submit: function () {
            ...
            //test location
            //
            // form.setAttribute('action', 'http://localhost:8989/getToken');//设置form上传action
            // form.submit();
            //console.log(data,'data')
            //
            // // $.ajax({
            // //     url: 'http://localhost:8989/getToken',
            // //     success: (data)=>{
        ...
        createHiddenField: function () {
            ...
            if (!signature) {
                ...
                $(self.signature).insertBefore('#uploadform input[type=file]');
            } else {
            ...
            if (!policy) {
                ...
                $(self.policy).insertBefore('#uploadform input[type=file]');
            } else {
                self.policy = policy;
            }
            ...
            function makeInput(name){
                ...
                self[name].name = name;
                $(self[name]).insertBefore('#uploadform input[type=file]');
            }
